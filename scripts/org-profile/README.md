...
git commit -m "docs: sync org profile for v1.4.0"
git push
```
...
gh api -X PATCH orgs/Dynamic-API-Platform \
  -f description='Open-source dynamic REST API platform — admin UI, MongoDB, cron/webhooks/MCP, Docker & Kubernetes (v1.4)' \
