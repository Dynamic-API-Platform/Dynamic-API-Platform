...
git commit -m "docs: sync org profile for v1.5.11"
git push
```
...
gh api -X PATCH orgs/Dynamic-API-Platform \
  -f description='Open-source dynamic REST API platform — admin UI, MongoDB, in-app software updates, cron/webhooks/MCP, Docker & Kubernetes (v1.5.11)' \
